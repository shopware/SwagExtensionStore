...
class InAppPurchasesControllerTest extends TestCase
{
    ...
    public function testOrderCartWithValidItem(): void
    {
        ...
        $service->expects(static::once())
            ->method('filterValidInAppPurchases')
            ->willReturn($this->getInAppPurchaseCartCollection());
    ...
    public function testOrderCartWithInvalidItem(): void
    {
        ...
        $service->expects(static::once())
            ->method('filterValidInAppPurchases')
            ->willReturn(new InAppPurchaseCartPositionCollection());
    ...
    public function testListPurchasesWithInvalidItems(): void
    {
        ...
        $service->expects(static::once())
            ->method('filterValidInAppPurchases')
            ->willReturn($this->getInAppPurchaseCollection(false));
    ...
    private function getInAppPurchaseCollection($valid = true): InAppPurchaseCollection
    {
    ...
    private function getInAppPurchaseCartCollection(): InAppPurchaseCartPositionCollection
    {
        return InAppPurchaseCartPositionCollection::fromArray([$this->getInAppPurchaseCartStructArray()]);
    }
}
