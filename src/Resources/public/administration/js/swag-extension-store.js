(()=>{var Pe=Object.defineProperty;var i=(e,t)=>()=>(e&&(t=e(e=0)),t);var o=(e,t)=>{for(var s in t)Pe(e,s,{get:t[s],enumerable:!0})};var g,u=i(()=>{g=`{% block sw_extension_store_index %}
...
{% endblock %}
`});var _e={};o(_e,{default:()=>Xe});var Xe,pe=i(()=>{de();Xe={template:ce,props:{type:{type:String,required:!0,validator(e){return["app","plugin"].includes(e)}}},computed:{isApp(){return this.type==="app"}}}});var we,xe=i(()=>{we=`{% block sw_extension_label_display %}
...
{% endblock %}
`});var me=i(()=>{});var ue={};o(ue,{default:()=>Qe});var Qe,ge=i(()=>{xe();me();Qe={template:we,props:{labels:{type:Array,required:!0}}}});var be,he=i(()=>{be=`{% block sw_extension_store_error_card %}
    <sw-meteor-card
