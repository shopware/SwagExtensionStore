(()=>{var Oe=Object.defineProperty;var i=(e,t)=>()=>(e&&(t=e(e=0)),t);var o=(e,t)=>{for(var s in t)Oe(e,s,{get:t[s],enumerable:!0})};var g,h=i(()=>{g=`{% block sw_extension_store_index %}
...
{% endblock %}
`});var X=i(()=>{});var J={};o(J,{default:()=>ot});var Y,nt,ot,Q=i(()=>{H();X();({Utils:Y,Filter:nt}=Shopware),ot={template:K,inject:["shopwareExtensionService"],props:{extension:{type:Object,required:!0}},computed:{previewMedia(){let e=Y.get(this.extension,"images[0]",null);return e?{"background-image":`url('${e.remoteLink}')`,"background-size":"cover"}:{"background-image":`url('${this.assetFilter("/administration/static/img/theme/default_theme_preview.jpg")}')`}},recommendedVariant(){return this.shopwareExtensionService.orderVariantsByRecommendation(this.extension.variants)[0]},hasActiveDiscount(){return this.shopwareExtensionService.isVariantDiscounted(this.recommendedVariant)},discountClass(){return{"sw-extension-listing-card__info-price-discounted":this.hasActiveDiscount}},calculatedPrice(){return this.recommendedVariant?this.$tc("sw-extension-store.general.labelPrice",this.shopwareExtensionService.mapVariantToRecommendation(this.recommendedVariant),{price:Y.format.currency(this.shopwareExtensionService.getPriceFromVariant(this.recommendedVariant),"EUR")}):null},isInstalled(){return!!Shopware.State.get("shopwareExtensions").myExtensions.data.some(e=>e.installedAt&&e.name===this.extension.name)},isLicensed(){let e=Shopware.State.get("shopwareExtensions").myExtensions.data.find(t=>t.name===this.extension.name);return e===void 0?!1:!!e.storeLicense},assetFilter(){return nt.getByName("asset")}},methods:{openDetailPage(){this.$router.push({name:"sw.extension.store.detail",params:{id:this.extension.id.toString()}})}}}});var ee,Z=i(()=>{ee=`{% block sw_extension_store_update_warning %}
    <sw-extension-store-error-card
        variant="info"
...
{% endblock %}
`});var pe={};o(pe,{default:()=>_t});var _t,_e=i(()=>{de();_t={template:ce,props:{type:{type:String,required:!0,validator(e){return["app","plugin"].includes(e)}}},computed:{isApp(){return this.type==="app"}}}});var we,xe=i(()=>{we=`{% block sw_extension_label_display %}
...
{% endblock %}
`});var me=i(()=>{});var he={};o(he,{default:()=>wt});var wt,ge=i(()=>{xe();me();wt={template:we,props:{labels:{type:Array,required:!0}}}});var be,ue=i(()=>{be=`{% block sw_extension_store_error_card %}
    <sw-meteor-card
...
{% endblock %}
`});var fe=i(()=>{});var ve={};o(ve,{default:()=>ht});var ht,ye=i(()=>{ue();fe();ht={template:be,props:{title:{type:String,required:!1},variant:{type:String,required:!1,default:"neutral",validator(e){return["info","danger","success","warning","neutral"].includes(e)}}},computed:{iconName(){switch(this.variant){case"danger":return"regular-times-circle";case"info":return"regular-info-circle";case"warning":return"regular-exclamation-circle";case"success":return"regular-check-circle";default:return"regular-info-circle"}},componentClasses(){return[`sw-extension-store-error-card--variant-${this.variant}`]}}}});var Se,ke=i(()=>{Se=`<sw-card
    v-if="showBanner"
...
`});var Ee=i(()=>{});var Pe={};o(Pe,{default:()=>ut});var Ae,ut,Ce=i(()=>{ke();Ee();Ae="SwagAnalytics",ut=Shopware.Component.wrapComponentConfig({template:Se,inject:["extensionStoreDataService"],i18n:{messages:{"en-GB":{"app-name":"Shopware Analytics","app-description":"Unlock store performance metrics","go-to-app":"Try it out now"},"de-DE":{"app-name":"Shopware Analytics","app-description":"Erfasse wichtige Shop-Kennzahlen","go-to-app":"Jetzt ausprobieren"}}},data(){return{extension:null,isAppInstalled:!1}},computed:{showBanner(){return!this.isAppInstalled},linkToStatisticsAppExists(){return!!this.extension},assetFilter(){return Shopware.Filter.getByName("asset")}},created(){this.createdComponent()},methods:{async createdComponent(){this.isAppInstalled=!!Shopware.Context.app.config.bundles[Ae],this.extension=await this.extensionStoreDataService.getExtensionByName(Ae,Shopware.Context.api)},goToStatisticsAppDetailPage(){this.linkToStatisticsAppExists&&this.$router.push({name:"sw.extension.store.detail",params:{id:this.extension.id}})}}})});var Te,Me=i(()=>{Te=`{% block sw_dashboard_index_content_intro_card %}
    {% parent %}
    <sw-dashboard-statistics-promotion-card />
{% endblock %}
`});var Ie=i(()=>{});var $e={};o($e,{default:()=>ft});var ft,De=i(()=>{Me();Ie();ft=Shopware.Component.wrapComponentConfig({template:Te})});var ze,Le=i(()=>{ze=`<div
    v-if="showBanner"
...
`});var Fe=i(()=>{});var Be={};o(Be,{default:()=>kt});var Ve,yt,kt,Ge=i(()=>{Le();Fe();Ve="SwagAnalytics",yt="2025-01-01 00:00:00.000",kt=Shopware.Component.wrapComponentConfig({template:ze,inject:["extensionStoreDataService","acl"],i18n:{messages:{"en-GB":{"badge-new":"Available now","promotion-title":"Shopware Analytics","promotion-text":"Discover the new suite of KPIs with your sales and performance metrics in Shopware. Get ready to benefit from an ever-expanding range of fresh insights to support your journey toward success!","app-name":"Shopware Analytics","app-description":"Unlock store performance metrics","go-to-app":"Try it out now"},"de-DE":{"badge-new":"Jetzt verf\xFCgbar","promotion-title":"Shopware Analytics","promotion-text":"Entdecke die neue Suite an Kennzahlen mit Deinen Verkaufs- und Leistungsmetriken in Shopware. Mach Dich bereit, von einer st\xE4ndig wachsenden Auswahl an Auswertungen zu profitieren, die Deine Reise zum Erfolg unterst\xFCtzen!","app-name":"Shopware Analytics","app-description":"Erfasse wichtige Shop-Kennzahlen","go-to-app":"Jetzt ausprobieren"}}},data(){return{isAppInstalled:!1,routeToApp:null}},computed:{showBanner(){return!this.isAppInstalled},showBadge(){return new Date<new Date(yt)},linkToStatisticsAppExists(){return!!this.routeToApp},assetFilter(){return Shopware.Filter.getByName("asset")}},created(){this.createdComponent()},methods:{async createdComponent(){if(this.isAppInstalled=!!Shopware.Context.app.config.bundles[Ve],!this.canAccessExtensionStore()){this.routeToApp={name:"sw.extension.store"};return}this.extensionStoreDataService.getExtensionByName(Ve,Shopware.Context.api).then(e=>{e&&(this.routeToApp={name:"sw.extension.store.detail",params:{id:e.id}})})},goToStatisticsAppDetailPage(){this.linkToStatisticsAppExists&&this.$router.push(this.routeToApp)},canAccessExtensionStore(){return this.acl.can("system.plugin_maintain")}}})});var{Criteria:d}=Shopware.Data,_=class extends Shopware.Classes.ApiService{constructor(t,s,n="extension-store"){super(t,s,n),this.name="extensionStoreDataService"}async listingFilters(t){return(await this.httpClient.get(`_action/${this.apiEndpoint}/store-filters`,{headers:this.basicHeaders(t),version:3})).data}async getExtensionList(t,s){let n=this._getCriteriaFromSearch(t),{data:a}=await this.httpClient.post(`_action/${this.apiEndpoint}/list`,n.parse(),{headers:this.basicHeaders(s),version:3}),r=[];return r.total=a.meta.total,r.push(...a.data),r}async getExtensionByName(t,s){return this.getExtensionList({term:t},s).then(n=>n.find(a=>a.name===t)??null)}async getDetail(t,s){let{data:n}=await this.httpClient.get(`_action/${this.apiEndpoint}/detail/${t}`,{headers:this.basicHeaders(s),version:3});return n}async getReviews(t,s,n){let a=new d(t,s),{data:r}=await this.httpClient.get(`_action/${this.apiEndpoint}/${n}/reviews`,{headers:this.basicHeaders(),params:a.parse(),version:3});return r}basicHeaders(t=null){let s={"Content-Type":"application/json",Accept:"application/json",Authorization:`Bearer ${this.loginService.getToken()}`};return t&&t.languageId&&(s["sw-language-id"]=t.languageId),s}_getCriteriaFromSearch({page:t=1,limit:s=25,rating:n=null,category:a=null,term:r=null,sorting:m=null,filter:Re={}}={}){let c=new d(t,s);r&&c.setTerm(r);let p=[];return n!==null&&p.push(d.equals("rating",n)),Object.entries(Re).forEach(([Ne,qe])=>{p.push(d.equals(Ne,qe))}),a!==null&&p.push(d.equals("category",a)),p.length>0&&c.addFilter(d.multi("AND",p)),m&&(c.resetSorting(),c.addSorting(m)),c}};var x=class extends Shopware.Classes.ApiService{constructor(t,s,n="extension-store"){super(t,s,n),this.name="extensionStoreLicensesService"}newCart(t,s){return this.httpClient.post(`/_action/${this.apiEndpoint}/cart/new`,{extensionId:t,variantId:s},{headers:this.basicHeaders(),version:3})}orderCart(t){return this.httpClient.post(`/_action/${this.apiEndpoint}/cart/order`,t,{headers:this.basicHeaders(),version:3})}getPaymentMeans(){return this.httpClient.get(`/_action/${this.apiEndpoint}/cart/payment-means`,{headers:this.basicHeaders(),version:3})}basicHeaders(t=null){let s={"Content-Type":"application/json",Accept:"application/json",Authorization:`Bearer ${this.loginService.getToken()}`};return t&&t.languageId&&(s["sw-language-id"]=t.languageId),s}};Shopware.Component.register("sw-extension-store-index",()=>Promise.resolve().then(()=>(f(),b)));Shopware.Component.register("sw-extension-store-listing",()=>Promise.resolve().then(()=>(E(),S)));Shopware.Component.register("sw-extension-store-detail",()=>Promise.resolve().then(()=>(T(),M)));Shopware.Component.register("sw-extension-store-slider",()=>Promise.resolve().then(()=>(F(),z)));Shopware.Component.register("sw-extension-store-listing-filter",()=>Promise.resolve().then(()=>(N(),R)));Shopware.Component.register("sw-extension-buy-modal",()=>Promise.resolve().then(()=>(W(),U)));Shopware.Component.register("sw-extension-listing-card",()=>Promise.resolve().then(()=>(Q(),J)));Shopware.Component.register("sw-extension-store-update-warning",()=>Promise.resolve().then(()=>(ie(),se)));Shopware.Component.register("sw-extension-label",()=>Promise.resolve().then(()=>(le(),re)));Shopware.Component.register("sw-extension-type-label",()=>Promise.resolve().then(()=>(_e(),pe)));Shopware.Component.register("sw-extension-store-label-display",()=>Promise.resolve().then(()=>(ge(),he)));Shopware.Component.register("sw-extension-store-error-card",()=>Promise.resolve().then(()=>(ye(),ve)));Shopware.Component.register("sw-extension-store-statistics-promotion",()=>Promise.resolve().then(()=>(Ce(),Pe)));Shopware.Application.addServiceProvider("extensionStoreDataService",()=>new _(Shopware.Application.getContainer("init").httpClient,Shopware.Service("loginService")));Shopware.Application.addServiceProvider("extensionStoreLicensesService",()=>new x(Shopware.Application.getContainer("init").httpClient,Shopware.Service("loginService")));Shopware.Module.register("sw-extension-store",{title:"sw-extension-store.general.title",name:"sw-extension-store.general.title",routePrefixName:"sw.extension",routePrefixPath:"sw/extension",routes:{store:{path:"store",redirect:{name:"sw.extension.store.listing"},meta:{privilege:"system.extension_store"},component:"sw-extension-store-index",children:{listing:{path:"listing",component:"sw-extension-store-listing",redirect:{name:"sw.extension.store.listing.app"},meta:{privilege:"system.extension_store"},children:{app:{path:"app",component:"sw-extension-store-listing",propsData:{isTheme:!1},meta:{privilege:"system.extension_store"}},theme:{path:"theme",component:"sw-extension-store-listing",propsData:{isTheme:!0},meta:{privilege:"system.extension_store"}}}}}},"store.detail":{component:"sw-extension-store-detail",path:"store/detail/:id",meta:{parentPath:"sw.extension.store",privilege:"system.extension_store"},props:{default:e=>({id:e.params.id})}}},routeMiddleware(e,t){t.name==="sw.extension.store.landing-page"&&(t.redirect={name:"sw.extension.store.listing"}),e(t)}});Shopware.Component.override("sw-dashboard-index",()=>Promise.resolve().then(()=>(De(),$e)));Shopware.Component.register("sw-dashboard-statistics-promotion-card",()=>Promise.resolve().then(()=>(Ge(),Be)));})();
