...
describe('sw-extension-listing-card', () => {
    ...
    it('should display one-time price for buying', async () => {
        ...
        expect(wrapper.find('.sw-extension-listing-card__info-price').html())
            .toContain('sw-extension-store.general.labelPriceOneTime');
    });
    ...
    it('should display a discount for renting', async () => {
        ...
        expect(wrapper.find('.sw-extension-listing-card__info-rating-count').text()).toBe('10');
        expect(wrapper.find('.sw-extension-listing-card__info-price-badge-sale').html())
            .toContain('sw-extension-store.general.labelSale');
        expect(wrapper.find('.sw-extension-listing-card__info-price-discounted').html())
            .toContain('sw-extension-store.general.labelPricePerMonth');
    });
});
