...
describe('sw-extension-listing-card', () => {
    ...
    it('pricePerMonth should be null when no variant given', async () => {
        wrapper = await createWrapper({
            label: 'Test',
            name: 'Test',
            labels: [],
        ...
        expect(wrapper.vm.pricePerMonth).toBeNull();
    });

    it('pricePerMonth should be equal to netPrice when montly variant given', async () => {
        wrapper = await createWrapper({
            id: 1,
            label: 'Test',
            name: 'Test',
        ...
        expect(wrapper.vm.pricePerMonth).toBe(19);
    });

    it('pricePerMonth should be equal to netPricePerMonth when yearly variant given', async () => {
        wrapper = await createWrapper({
            id: 1,
            label: 'Test',
            name: 'Test',
        ...
        expect(wrapper.vm.pricePerMonth).toBe(16.58);
    });
