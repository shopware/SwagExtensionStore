...
async function createWrapper() {
    return mount(await Shopware.Component.build('sw-extension-store-listing-filter'), {
        global: {
            stubs: {
                'sw-loader': true,
...
describe('SwagExtensionStore/module/sw-extension-store/component/sw-extension-store-listing-filter', () => {
    ...
    it('should render the sorting', async () => {
        const sorting = wrapper.getComponent('.sw-extension-store-listing-filter__sorting');
    ...
    it('should render a meteor single select for each filter', async () => {
        const filters = wrapper.findAllComponents('.sw-extension-store-listing-filter__filters');
