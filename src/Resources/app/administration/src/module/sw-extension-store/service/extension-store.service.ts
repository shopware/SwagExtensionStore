...
export default class ExtensionStoreService {
    ...
    private discountCampaignService: ShopwareDiscountCampaignService;

    private extensionService: ShopwareExtensionService;

    constructor(
        discountCampaignService: ShopwareDiscountCampaignService,
        extensionService: ShopwareExtensionService
    ) {
